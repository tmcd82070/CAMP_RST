...
# 2.  Collect .RData objects from wherever they are saved (usually "holding" directory defined in eff_model.enh) and place
#     in package campR folder inst/enhEffStats.
