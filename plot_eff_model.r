...
#'   includes variables TrapPositionID, batchDate, nReleased, nCaught,
#'   efficiency, imputed.eff, and trapPositionID.  Variable TrapPositionID and
#'   trapPositionID appear to be the same, although both are called in
