#' @title Assign batch date to records.
#'   
#' @param df The data frame containing temporal records for which a day must be 
#'   assigned.
#'   
...
#'   
#' @section: Details: In order to process the sequence of dates correctly, 
